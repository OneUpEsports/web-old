...
const Tournament=({date,format,rule,price,up,down,leftNb,rightNb})=>{
    return(
        ...
        <div className="grid grid-cols-6 grid-flow-col-dense w-full text-white  ">
            ...
            <div className="flex  items-center justify-center"><h4 className=" flex flex-col items-center justify-center w-fit m-auto font-bold">{rule} <span className="block mt-3 flex lg:flex-row flex-col items-center justify-center"><span className=" block rounded-2xl text-black bg-[#b2f617] px-3 py-1 font-bold lg:mr-4">{leftNb}</span>V<span className="block lg:ml-4 rounded-2xl text-black bg-[#b2f617] px-3 py-1 font-bold">{rightNb}</span></span> </h4></div>
