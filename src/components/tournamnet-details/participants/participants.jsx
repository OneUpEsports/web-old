        ...
        <div>
            ...
            <div className="flex justify-center">
                ...
                <div className="w-full lg:w-4/5">
                    {/* text_div */}
                    <div className="pt-8 pb-6 px-2 flex justify-center">
                        <p className="text-base text-center font-bold">THEY HAVE ALREADY SIGN UP FOR THIS TOURNAMENT:</p>
                    </div>
                    {/* participants_main_div  */}
                    <div className=" participants_main_div flex flex-wrap pb-14 px-2 ">
                        {participantsdata?.map((single, index) => (
                            <div className="w-full lg:w-2/6 px-2 py-2">
                                <div className="card_div  flex flex-col rounded ">
                                    ...
                                    >
                                        ...
                                        {/* title_arrow_div */}
                                        <div className=" w-3/4 title_arrow_div flex items-center justify-between lg:w-4/5 pl-2.5">
                                            {/* title_div */}
                                            <div>
                                    ...
                                    {/* drop_down_div */}
                                    {single?.show ? (
                                        <div className="drop_down_div  rounded-b">
                                            {/* winner_div */}
