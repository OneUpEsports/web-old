        ...
        <div className="w-full lg:w-4/5">
          ...
          <div className=" rounds_main_bg_color_div p-6 my-10">
            ...
            <div className="rounds_content_main_div  ">
              {/* winner_brackets_heading_div */}
              <div className="winner_brackets_heading_div w-full mb-4">
                <p className="text-white text-base font-bold uppercase ">
                  {RoundsLists?.winnerTitle}
                </p>
                {/* green_border_bottom_div */}
            ...
            {/* rounds_content_main_div_for_looser_Data */}
            <div className="rounds_content_main_div ">
              {/* Loser_brackets_heading_div */}
              <div className="winner_brackets_heading_div w-full mb-4 ">
                <p className="text-white text-base font-bold uppercase ">
                  {RoundsLists?.loserTitle}
                </p>
                {/* green_border_bottom_div */}
                <div className=" border_bottom_div"></div>
              </div>
              {/* rounds_container_main_div */}
              {roundsdata?.loserRecords?.map((single, index) => (
                <div className=" rounds_container_main_div ">
                  {/* rounds_status_main_div */}
                  <div
                    className="rounds_status_main_div flex items-center cursor-pointer py-4"
                    onClick={() => {
                      showLoserRecordsHandler(index);
                    }}
                  >
                    {/* round_number_heading */}
                    <div className="w-44 px-7">
