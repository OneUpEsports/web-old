...
const SocialLinks =()=>{
    ...
    return (
        <>   
        <button className="bg-indigo-400 rounded block text-white w-72 h-10 mb-1 text-sm font-bold  m-auto " ><BsTwitch className={iconStyle}/>CONTINUE WITH TWITCH</button>
        <button className="bg-blue-400 rounded block text-white w-72 h-10 mb-1 text-sm font-bold  m-auto "><BsDiscord className={iconStyle}/>CONTINUE WITH DISCORD</button>
