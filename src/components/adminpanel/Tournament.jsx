...
const Tournament = ({image,form,game,joined,id,type,status,edit}) => {
    return(
        <Link to="/adminpanel/tournament/info">
        <div className="flex items-center grid grid-cols-14 grid-flow-col-dense w-full bg-[#f8fafb]  h-16 my-3 ">
                       ...
                       <div className=" col-span-1"><h4 className="  w-fit m-auto text-[#3ed669]">{joined}</h4></div>
