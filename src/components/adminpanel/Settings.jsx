...
const Settings = ({ children }) => {
    ...
    return (
        <div className="   w-full flex flex-col items-center justify-center lg:pl-12  ">
            <form className="flex lg:flex-row flex-col w-full m-auto items-center justify-center ">
                ...
                <div className="lg:w-1/2 lg:ml-4 w-full  items-center justify-center text-md">
                    ...
                    <div className="text-black ">
                        ...
                        <input
                            className="mr-2 h-5 w-5 text-[#000]"
                            type="radio"
                            id="individual"
                            name="mode"
                            value="individual"
                        />
                        <label className="mr-4 " for="individual">
                            Individual
                        </label>
                        <input
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="bracet"
                        />
                        <label className="mr-4" for="bracet">
                            Bracket
                        </label>
                        <input
                            className="mr-2 h-5 w-5 "
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="15min"
                        />
                        <label className="mr-4" for="15min">
                            15min
                        </label>
                        <input
                            className="mr-2 h-5 w-5 "
                            ...
                            value="30min"
                        />
                        <label className="mr-4" for="30min">
                            30min
                        </label>
                        <input
                            className="mr-2 h-5 w-5"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="Crossplay"
                        />
                        <label className="mr-4" for="crossplay">
                            Crossplay
                        </label>
                        <input
                            className="mr-2 h-5 w-5 "
                            ...
                            value="PS4/5"
                        />
                        <label className="mr-4" for="ps4/5">
                            ps4/5
                        </label>
                        <input
                            className="mr-2 h-5 w-5"
                            ...
                            value="XB/XBX"
                        />
                        <label className="mr-4" for="xb/xbx">
                            XB/XBX
                        </label>
                        <br />
                        <input
                            ...
                            value="Mobile"
                        />
                        <label className="mr-4" for="mobile">
                            Mobile
                        </label>
                        <input
                            className="mr-2 h-5 w-5 "
            ...
            <button className="mt-8 bg-[#3ed669] px-4 py-2 text-md text-white rounded">
                Save
            </button>
        </div>
    );
