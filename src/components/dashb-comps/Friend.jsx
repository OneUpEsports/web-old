    ...
    return(
        ...
        <div className="grid grid-cols-5 grid-flow-col-dense  w-full px-6  overflow-x-scroll   scrollbar-hide">
            ...
            <div className="flex items-center justify-left pl-6  col-span-1">
                <img className="h-16 w-16 mr-3" src={image} alt=""/>
            ...
            <img className="h-10 w-10 mr-1 ml-2" src="/img/create_team/valorant_preview.png" alt=""/>
            <img className="h-10 w-10 mr-1 ml-2" src="/img/create_team/rocketleague_preview.png" alt=""/>
            <img className="h-10 w-10 mr-1 ml-2" src="/img/create_team/apex_preview.png" alt=""/>
            </div>
            </div>
            <div className="flex  items-center justify-center col-span-2">
            <button className="rounded-xl bg-gray-200  w-24 h-8 text-md "
            >Invite</button>
            </div>
