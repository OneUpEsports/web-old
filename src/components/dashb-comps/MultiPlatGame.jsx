...
const MultiPlatGame = ({image,name}) => {
    return(
        <div className="relative flex flex-col items-center justify-center rounded-2xl  lg:w-auto lg:h-auto md:w-60 md:h-48 w-48 h-36">
            ...
            <button className="mx-2"><Link to="/dashboard"><img src="/img/dashboard/Gruppe 142.png" alt=""/></Link></button>
            <button className="mx-2"><Link to="/dashboard"><img src="/img/dashboard/Gruppe 156.png" alt=""/></Link></button>
            <button className="mx-2 bg-gray-900 rounded-md w-10 h-10 flex flex-col items-center justify-center text-center"><Link to="/dashboard"><img src="/img/dashboard/Pc.png" alt=""/></Link></button>
            </div>
