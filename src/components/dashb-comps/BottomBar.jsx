...
const BottomBar = () => {
    return(
        <div className="flex flex-col lg:flex-row  items-center justify-between pr-4">
            <div className="flex">
                <Link to="#"  className="px-2"><BsDiscord/></Link>
                <Link to="#"  className="px-2"><BsTwitter /></Link>
                <Link to="#"  className="px-2"><BsInstagram /></Link>
                <Link to="#"  className="px-2"><BsYoutube /></Link>
                <Link to="#"  className="px-2"><BsTwitch /></Link>
            </div>
