    ...
    return(
        <MainLayout>
               ...
               <div className="flex items-center mb-8"><h2>Games</h2></div>
                <Link  className="w-full h-52 bg-[#f8fafb] flex items-center justify-center" to="/adminpanel/games/create"><button className="bg-[#f8fafb]     text-[#c4c4c4] text-4xl font-bold"><AiOutlinePlus /></button></Link>
