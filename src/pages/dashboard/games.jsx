        ...
        <MainLayout>
            <div className="w-full h-full  lg:p-12 p-2">
                ...
                <div className=" h-full  w-11/12 m-auto grid lg:grid-cols-4 lg:grid-rows-3  md:grid-cols-2 md:grid-rows-7 grid-cols-1 grid-rows-11 lg:gap-x-12  gap-y-6 ">
                      <MultiPlatGame image="/img/dashboard/NoPath - Kopie (3).png" name="APEX LEGENDS" pclink="/tournaments/pc/apex-legends" pslink="/tournaments/crossplay/apex-legends" xboxlink="/tournaments/xbox/apex-legends"/>
                      ...
                      <MultiPlatGame image="/img/dashboard/lsu1ddvx.png" name="CALL OF DUTY WARZONE" pclink="/tournaments/pc/call-of-duty-warzone" pslink="/tournaments/crossplay/call-of-duty-warzone" xboxlink="/tournaments/xbox/call-of-duty-warzone"/>
                      ...
                      <MultiPlatGame image="/img/dashboard/NoPath - Kopie (10).png" name="FORTNITE" pclink="/tournaments/pc/fortnite" pslink="/tournaments/crossplay/fortnite" xboxlink="/tournaments/xbox/fortnite"/>
                      ...
                      <MultiPlatGame image="/img/dashboard/NoPath - Kopie (18).png" name="ROCKET LEAGUE" pclink="/tournaments/pc/rocket-league" pslink="/tournaments/crossplay/rocket-league" xboxlink="/tournaments/xbox/rocket-league"/>
