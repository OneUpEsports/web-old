        ...
        <MainLayout>
            <div className="w-full h-full  lg:p-12 p-2">
                ...
                <div className=" h-full  w-11/12 m-auto grid lg:grid-cols-4 lg:grid-rows-3  md:grid-cols-2 md:grid-rows-7 grid-cols-1 grid-rows-11 lg:gap-x-12  gap-y-6 ">
                      ...
                      <MultiPlatGame image="/img/dashboard/NoPath - Kopie (23).png" name="ROLLER CHAMPIONS" pclink="/tournaments/crossplay/roller-champions" pslink="/tournaments/crossplay/roller-champions" xboxlink="/tournaments/crossplay/roller-champions"/>
