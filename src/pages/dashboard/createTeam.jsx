...
const CreateTeam=()=>{
    return (
        <MainLayout>
               <div className="lg:w-full w-11/12 h-full lg:p-12 py-12 pr-12 pl-2  lg:m-0 mr-2 flex flex-col items-center justify-center">
            <div className="w-full h-full  lg:px-12    pb-12 ">
            <h3 className="flex mb-4">My Teams <img className="ml-2" src="/img/dashboard/Icon ionic-ios-people.png" alt=""/></h3>
            <div className=" flex flex-col items-center lg:justify-center justify-left h-full  lg:w-11/12 w-full lg:m-auto rounded-2xl border-2 border-gray-200 bg-[#1a202c]">
               <div className="w-full lg:px-16 flex lg:flex-row flex-col items-center justify-between  h-1/3 py-4 ">
                   {/* <div className="flex items-center justify-center md:flex-row flex-col  md:mb-auto mr-6  "> */}
                   ...
                   {/* </div> */}
                    <div  className="relative flex flex-col flex-items justify-center w-fit">
                            ...
                            <button><img className="lg:w-full lg:h-36" src="/img/create_team/Team_Banner.png"/></button>
                    </div>
               </div>
               ...
               <div className="relative flex flex-col items-center justify-left h-2/3 w-full lg:px-16">
                   ...
                   <div className="bg-[#383d47] flex flex-col items-center   w-full  bg-gray-900 justify-center h-5/6  rounded-2xl border-2 border-gray-200 pt-6  overflow-x-scroll overflow-y-scroll scrollbar-hide">
