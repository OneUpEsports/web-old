...
const Subscribe = () => {
    ...
    const socialLinksBoxStyle="buttons min-w-fit  m-auto justify-items-center  justify-center items-center"
    const socialLinksTitleStyle="text-center text-base mb-2"
    const signUpBtnStyle="bg-indigo-900 rounded block text-white w-64 h-10 mt-2 mb-4 text-sm font-bold  m-auto "
