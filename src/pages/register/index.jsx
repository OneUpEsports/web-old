...
const Subscribe = () => {
    ...
    return (
        <div className="flex flex-col justify-arround absolute bottom-0 right-0  bg-black m-0 h-full  w-full items-center  m-0 p-0 overflow-x-hidden overflow-y-scroll">
