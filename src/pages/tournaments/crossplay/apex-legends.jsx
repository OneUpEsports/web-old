    ...
    return(
        <div className="absolute  bottom-0 right-0 h-full w-full bg-secondary-100  overflow-x-hidden overflow-y-scroll">
            ...
            <div className="relative ">
                <img className="opacity-50 lg:h-[calc(100vh-450px)]  h-96 w-screen" src="/img/tournament/tournament_banner.png" alt=""/>
                <div className=" z-50 flex flex-col items-center justify-center  ">
                    ...
                    <div className="flex  w-64 m-auto items-center justify-between">
